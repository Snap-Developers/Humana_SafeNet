...
import static com.snaplogic.snaps.SafeNetProtectApp.Messages.SAFENET_AES_DECRYPT_DESC;
import static com.snaplogic.snaps.SafeNetProtectApp.Messages.SAFENET_AES_DECRYPT_LABEL;
...
/**
 * The AES Decrypt snap decrypts the binary documents it receives on its input view using the
 ...
 * @author sprasad
 */
@General(title = SAFENET_AES_DECRYPT_LABEL, purpose = SAFENET_AES_DECRYPT_DESC)
@Category(snap = SnapCategory.WRITE)
@Version(snap = 1)
public class AESDecrypt extends AbstractSymmetricCryptoSnap {
